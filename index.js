...
(function (_0x12ec2d, _0x25bf65) {
    ...
    while (!![]) {
      ...
      console.log(color("Congrats, Gifted Dreaded Bot has Successfully Connected to the Server", "green"));
      console.log(color("Follow me on GitHub as Giftedmaurice", "red"));
      console.log(color("Text the bot number with .menu to check my command list"));
      client.sendMessage(owner + "@s.whatsapp.net", { text: `Gifted DreadedBot has Started... [ACTIVE NOW]` });
    }
